     ...
     <Form>
      <FormGroup className="form-group">
       ...
       <Input type="text" name="email" id="email" value={email}
        ...
        invalid={err.email} />
       <FormFeedback> {err.email && "Email wajib di isi"}</FormFeedback>
      </FormGroup>
      <FormGroup className="form-group">
       ...
       <FormFeedback> {err.username && "Username wajib di isi"}</FormFeedback>
      </FormGroup>
      <FormGroup className="form-group">
       ...
       <FormFeedback> {err.password && "Password harus di isi"}</FormFeedback>
      </FormGroup>
      <FormGroup className="form-group">
       ...
       <FormFeedback> {err.rePassword && "Repassword harus di isi"}</FormFeedback>
      </FormGroup>
